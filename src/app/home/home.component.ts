...
export class HomeComponent implements OnInit {
 ...
 // dataSource: any; enable when request with backend server
  ...
  constructor(
    ...
    private backendService: BackendService,  public authService: AuthenticationService,private store:Store
  ) {
 ...
 this.store.select(selectSiteId).subscribe(siteId => {
  ...
  console.log("home",this.site)
    ...
    // console.log(localStorage.getItem('siteValue'));
  }
  // get selectedSites():string{
  //   console.log(this.authService.sharedSiteData);
