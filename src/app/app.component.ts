...
export class AppComponent implements OnInit, OnChanges, OnDestroy {
  ...
  constructor(
    ...
    private idle: Idle, private keepalive: Keepalive,private store: Store
  ) {
  ...
  selected(value){
    ...
    let val = "2";
    localStorage.setItem('siteValue',value);
    this.store.dispatch(setSiteSelection({siteId:value.value}));
